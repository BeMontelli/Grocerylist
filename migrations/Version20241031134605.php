 ...
 */
final class Version20241031134605 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64997A567A9 FOREIGN KEY (current_grocery_list_id) REFERENCES grocery_list (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
